...
V =
    C == "ruRU" and { -- 42/44 (95%)
      ...
      "Используйте ещё раз, чтобы запретить изменять этот облик по ситуации.", "Использовать наивысший изученный ранг", "Способности местности", "Метки на местности", "Общие способности",
      "Список способностей",
    } or nil
...
K = V and {
      ...
      "Use again to prevent this apperance from being replaced by a Situation.", "Use the highest known rank", "Zone Abilities", "Raid world markers", "General abilities",
      "Spell flyout",
}
