...
if not (R and R.AddDefaultRing) then
	return
end
...
local commonTrades = {
	...
	}, -- engineering
	{
		id = 2656,
		_u = "m"
	}, -- smelting (WotLK: нет mining journal)
	{
		id = "/cast [mod] {{spell:31252}}; {{spell:25229/51311}}",
		_u = "j"
	}, -- jewelcrafting/prospecting (TBC+)
	{
		id = "/cast [mod] {{spell:51005}}; {{spell:45357/45363}}",
		_u = "i"
	}, -- inscription/milling (WotLK+)
...
if playerClass == "DEATHKNIGHT" then
	table.insert(commonTrades, 11, {
		id = 53428,
		_u = "u"
	}) -- runeforging перед firstAid, только ДК
end
