...
local function canOpen()
	return C_BattlePass.IsActiveOrHasRewards() and not C_Hardcore.IsFeature1Available(Enum.Hardcore.Features1.BATTLEPASS_REWARDS)
end
...
local defs = {
	open = {
		L"Open Battle Pass", "Interface/Icons/INV_Misc_Book_09",
		function()
	...
	quests = {
		L"Open quests", "Interface/Icons/INV_Misc_Note_02",
		function()
	...
	daily = {
		L"Complete daily quests", "Interface/Icons/Achievement_Quests_Completed_04",
		function()
	...
	all = {
		L"Complete all quests", "Interface/Icons/Achievement_Quests_Completed_08",
		function()
	...
	rewards = {
		L"Collect rewards", "Interface/Icons/INV_Misc_Gift_02",
		function()
...
AB:AugmentCategory(L"Battle Pass", function(_, add)
	if not C_BattlePass.IsEnabled() then return end
	for i=1,#order do
